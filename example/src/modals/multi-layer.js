		...
		<div className={props.className}>
			...
			<div className="modal-content">
				...
				<div className="wysiwyg">
                    ...
                    <p><button className="link" onClick={() => { openModal('text', {layer: 2, title: 'Top layer modal', content: 'This layer has been opened on another layer. Therefore it doesn\'t affect the previous modal.'}) }}>Click here</button> to open another modal on top of this one.</p>
                </div>
			</div>
		</div>
	)
